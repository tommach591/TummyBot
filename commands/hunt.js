                ...
                if (args.length < 2) {
                    ...
                    if (args[1] == "sort") {
                        ...
                        switch(type) {
                            ...
                            case "mix":
                                userHunt[userid].scrolls.sort((firstEl, secondEl) => { 
                                    if (scrolls[firstEl].attack > scrolls[secondEl].attack && scrolls[firstEl].magic > scrolls[secondEl].magic && scrolls[firstEl].attack == scrolls[firstEl].magic) {
                                        return -1;
                                    }
                                    if (scrolls[firstEl].attack < scrolls[secondEl].attack && scrolls[firstEl].magic < scrolls[secondEl].magic && scrolls[secondEl].attack == scrolls[secondEl].magic) {
                                        return 1;
                                    }
                                    if (scrolls[firstEl].name < scrolls[secondEl].name) {
                                        return -1;
